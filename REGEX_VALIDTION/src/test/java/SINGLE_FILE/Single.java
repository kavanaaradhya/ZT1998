...
public class Single {
    ...
    public static void main(String[] args) {
        ...
        String emailFilePath1 = "/Users/kavana/eclipse-workspace/REGEX_VALIDTION/src/test/java/EMAIL_REGEX/Email_src.txt";
        String emailFilePath2 = "/Users/kavana/eclipse-workspace/REGEX_VALIDTION/src/test/java/EMAIL_REGEX/Email_tgt.txt";
        compareRegexInFiles(emailFilePath1, emailFilePath2, "Email");

        // Example usage for URL comparison
        String urlFilePath1 = "/Users/kavana/eclipse-workspace/REGEX_VALIDTION/src/test/java/URL_REGEX/Url_src.txt";
        String urlFilePath2 = "/Users/kavana/eclipse-workspace/REGEX_VALIDTION/src/test/java/URL_REGEX/Url_tgt.txt";
        compareRegexInFiles(urlFilePath1, urlFilePath2, "URL");

        // Example usage for phone number comparison
        String phoneFilePath1 = "/Users/kavana/eclipse-workspace/REGEX_VALIDTION/src/test/java/REGEX/Phone_num_src.txt";
        String phoneFilePath2 = "/Users/kavana/eclipse-workspace/REGEX_VALIDTION/src/test/java/REGEX/Phone_num_tgt.txt";
