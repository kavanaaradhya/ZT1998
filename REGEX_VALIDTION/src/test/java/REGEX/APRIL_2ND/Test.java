...
public class Test {
    ...
    public static boolean compareMatchers(Matcher inputMatcher, Matcher patternMatcher) {
        
       if(inputMatcher.find() && patternMatcher.find())
    	   {
    	   return true;
    	   }
       else
    ...
    public static void main(String[] args) {
        String srcFilePath = "/Users/kavana/Documents/Workspace1/Regex_validation/src/test/java/APRIL_2ND/Url_Src.txt";
        String tgtFilePath = "/Users/kavana/Documents/Workspace1/Regex_validation/src/test/java/APRIL_2ND/Url_Tgt.txt";
        ...
        try {
            ...
            boolean match = compareMatchers(inputMatcher, patternMatcher);
