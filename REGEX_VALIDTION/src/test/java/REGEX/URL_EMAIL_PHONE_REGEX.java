...
public class URL_EMAIL_PHONE_REGEX {
    public static void main(String[] args) {
        String srcFilePath = "/Users/kavana/eclipse-workspace/REGEX_VALIDTION/src/test/java/REGEX/URL_EMAIL_PHONE_SRC.txt"; 
        String tgtFilePath = "/Users/kavana/eclipse-workspace/REGEX_VALIDTION/src/test/java/REGEX/URL_EMAIL_PHONE_TGT.txt";
